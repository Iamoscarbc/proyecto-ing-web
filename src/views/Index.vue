<template>
    <div>
        <div class="d-flex flex-column align-items-center">
                        ...
                        <div class="d-flex flex-column justify-content-center">
                            <div class="contenedor-ida-vuelta">                                
                                ...
                                <div class="d-flex flex-column align-items-center tamaño_select">
                                    ...
                                    <v-select :options="origen" style="width:100%;" @input="cambio_Origen" :reduce="country => country.idOrigen" label="country"></v-select>
                                </div>
                                <!-- //Destino -->
                                <!-- <base-input class="input-group-alternative mb-3 tamaño-input"
                                        placeholder="Destino"
                                ...
                                <div class="d-flex flex-column align-items-center tamaño_select">
                                    ...
                                    <v-select :options="destino" style="width:100%;" @input="cambio_Destino" :reduce="country => country.idDestino" label="country"></v-select>
                                </div>
                            </div>
                            <div class="contenedor-ida-vuelta">
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex flex-row">
                                        ...
                                        <datetime v-model="date_ida" :min-datetime="min_date_ida" :input-id="'ida'" @close="recargo"></datetime>
                                    </div>
                                </div>
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex flex-row">
                                        ...
                                        <datetime v-model="date_regreso" :min-datetime="min_date_vuelta" :input-id="'vuelta'"></datetime>
                                    </div>
                                </div>
                            </div>
                            <div class="contenedor-ida-vuelta">
                        ...
                        <div class="d-flex flex-column justify-content-center">
                            ...
                            <div class="d-flex flex-column align-items-center" style="margin-bottom:20px;">
                                ...
                                <div class="d-flex flex-row">
                                    ...
                                    <datetime v-model="date_ida" :min-datetime="min_date_ida" :input-id="'soloida'"></datetime>
                                </div>
                            </div>
                            <div class="contenedor-ida-vuelta">
                            ...
                            <div class="d-flex flex-row justify-content-center">
                                <button class="btn btn-danger tamaño_button" v-b-modal.modal-viajes @click="buscar('ida')">
                                    <svg aria-hidden="true" style="width:8%;" focusable="false" data-prefix="fas" data-icon="search" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="svg-inline--fa fa-search fa-w-16 fa-fw fa-lg"><path fill="currentColor" d="M505 442.7L405.3 343c-4.5-4.5-10.6-7-17-7H372c27.6-35.3 44-79.7 44-128C416 93.1 322.9 0 208 0S0 93.1 0 208s93.1 208 208 208c48.3 0 92.7-16.4 128-44v16.3c0 6.4 2.5 12.5 7 17l99.7 99.7c9.4 9.4 24.6 9.4 33.9 0l28.3-28.3c9.4-9.4 9.4-24.6.1-34zM208 336c-70.7 0-128-57.2-128-128 0-70.7 57.2-128 128-128 70.7 0 128 57.2 128 128 0 70.7-57.2 128-128 128z" class=""></path></svg>
                                    Buscar Viajes
                                </button>
                            </div>
            ...
            <Modal2 :arregloIda="arregloIda" :arregloVuelta="arregloVuelta"></Modal2> 
        </div>
    </div>
</template>
